...
|------|-------------|-------------|
| Admin | Full system access | Create, edit, delete staff, access all apps, manage everything |
| Manager | Full access except staff | Access all apps, cannot manage staff accounts |
| Staff | Operational access | Manage animals, shelter, fostering, adoptions |
| Veterinarian | Medical access only | View pets, add medical records, view statistics |
| Adopter | Public user access | View available pets, submit applications, track status |
| Volunteer | Read-only access | View public information only |
